...
(function () {
    ...
    bot.hears(new RegExp(strForbWord, "gi"), (ctx) => __awaiter(this, void 0, void 0, function* () {
        ...
        const res = ["Hindari penggunaan kata-kata kasar", "Kasar amat lu", "Dilarang berkata kasar"];
...
(function () {
    ...
    bot.hears(new RegExp(reg), (ctx) => __awaiter(this, void 0, void 0, function* () {
        const res = ["Hi " + ctx.from.first_name, "Hello", "Hei", "Hai", "Hi", "Halo"], index = yield Math.floor(Math.random() * res.length);
        setTimeout(() => ctx.reply(res[index]), speed[inSpeed]);
    }));
})();
(function () {
    ...
    bot.hears(new RegExp(reg), (ctx) => __awaiter(this, void 0, void 0, function* () {
        const res = ["Lagi rebahan aja nih dikamar", "Lagi godain cewek", "Lagi nugas nih, puyeng gua gk kelar-kelar"], index = yield Math.floor(Math.random() * res.length);
        setTimeout(() => ctx.reply(res[index]), speed[inSpeed]);
        setTimeout(() => {
